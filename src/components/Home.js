    ...
    render() {
        return (
            <div className='homepage-main-container'>
                ...
                <h4>Learn More</h4>
                <h4> &#x2193; </h4>
                <div className='phylot-overview-container'>
